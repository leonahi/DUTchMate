...
- **Next step:** Continue with loaded DUT-cable hot-plug and UART cable/edge
  validation. The maximum intended cable length and oscilloscope measurement
  setup must be identified before that result can close the corresponding
  section 14 checks. Passive/ESD validation follows.
