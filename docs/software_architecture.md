...
- Device Core Service endpoints for status, finite capture, GPIO mode, reset,
  and boot-mode.
...
- Log/session and higher-level workflow Device Core Service endpoints.
- Log/session and higher-level workflow CLI commands.
- MCP server runtime.
- RP2040 firmware.
