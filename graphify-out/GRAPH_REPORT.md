...
## Corpus Check
- 361 files · ~282,516 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 5074 nodes · 13540 edges · 245 communities (231 shown, 14 thin omitted)
- Extraction: 82% EXTRACTED · 18% INFERRED · 0% AMBIGUOUS · INFERRED: 2427 edges (avg confidence: 0.91)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `248fb2e2`
...
## Communities (245 total, 14 thin omitted)
...
Cohesion: 0.05
Nodes (60): PatternDetector, PatternMatch, Pattern detection for completed UART log lines., A configured pattern found in one UART log line., Find configured text patterns in completed UART log lines., Configured patterns in scan order., Return all configured patterns present in one completed UART line., Return pattern matches for a sequence of completed UART lines. (+52 more)
...
Cohesion: 0.11
Nodes (40): main(), Service entrypoint for DUTchMate., Start the Device Core Service., load_startup_hardware_config(), Path, Load startup hardware configuration, treating a missing file as empty config., BackendConfig, BackendConfigError (+32 more)
...
Cohesion: 0.16
Nodes (34): AdvancingMonotonicClock, enhanced_info(), FakeCaptureSource, FakeMonotonicClock, BackendCapability, BackendEvent, _fixed_session_time(), datetime (+26 more)

### Community 11 - "app.py"
Cohesion: 0.06
Nodes (45): _close_runtime(), FastAPI, FastAPI application factory for the Device Core Service., DUTchMate Device Core Service package., baseline_mutation_payload(), BootModeRequest, BootTestRequest, CaptureRequest (+37 more)

### Community 12 - "NdjsonStreamParser"
Cohesion: 0.08
Nodes (33): HelloMessage, Typed protocol messages received from the Debug Helper., Debug Helper hello handshake., UART bytes captured by the Debug Helper., UartMessage, _frame_body(), NdjsonStreamParser, DeviceMessage (+25 more)

### Community 13 - "metadata.py"
Cohesion: 0.09
Nodes (41): _append_resumed_backend_segment(), _backend_segment_json(), _capability_policy_json(), _contiguous_native_segments(), _format_session_id_timestamp(), _format_utc_timestamp(), _initial_metadata(), _integrity_json() (+33 more)
...
Cohesion: 0.04
Nodes (29): CaptureReconnect, CaptureSessionStorage, CaptureSourceMonitor, CaptureWorkflowLifecycle, BaseException, Protocol, TracebackType, Persistence operations required by the capture application service. (+21 more)

### Community 16 - "validation.py"
Cohesion: 0.05
Nodes (61): BootMode, Return the current state for a physical control channel., GpioIdentifierValidationError, _is_unicode_whitespace(), prepare_uart_send_payload(), GpioControlChannel, ValueError, Shared validation for public Device Core input contracts. (+53 more)
...
Cohesion: 0.08
Nodes (58): parse_device_message(), DeviceMessage, Parse one NDJSON device-to-host protocol line. This parser currently supports…, _command_error_line(), _hello_line(), parametrize, test_command_error_detail_accepts_and_preserves_exact_utf8_value(), test_command_error_detail_rejects_non_string_value() (+50 more)

### Community 20 - "DeviceCoreRuntime"
Cohesion: 0.06
Nodes (27): Core DUTchMate library., DeviceCoreRuntime, DeviceCoreRuntimeError, BackendCapability, GpioRoleName, RuntimeError, SessionWorkflow, Close the live source represented by this session-local view. (+19 more)

### Community 21 - "log_replay.py"
Cohesion: 0.15
Nodes (42): _decode_uart_event(), _existing_paths(), _latest_terminal_native(), _non_negative_int(), _oversized_record(), Path, Bounded replay of persisted native UART evidence., Select one native session and replay its newest bounded UART lines. (+34 more)
...
Cohesion: 0.09
Nodes (40): test_recent_logs_payload_removes_oldest_whole_records_to_fit_body_cap(), _compare_lines(), _compare_pattern_counts(), compare_session(), _decode_line(), _evidence_summary(), _line_excerpt(), _logs() (+32 more)
...
Cohesion: 0.05
Nodes (24): Protocol, SessionDetail, Return one bounded newest-first session page., Return bounded schema-aware detail for one session., Return bounded recent UART replay for one selected session., Designate one eligible session as the project baseline., Clear the baseline only when it names the requested session., Compare one terminal session with the designated baseline. (+16 more)
...
Cohesion: 0.09
Nodes (41): GpioConfigError, HardwareControlMapping, load_hardware_gpio_config(), _optional_string(), _optional_voltage(), _parse_control_mapping(), parse_hardware_gpio_config(), Any (+33 more)

### Community 30 - "BackendInfo"
Cohesion: 0.06
Nodes (27): EnhancedReconnectHost, Ready async Enhanced host used as source, control, and UART sender., Return immutable Basic backend identity and capabilities., BackendEventSource, BackendInfo, BackendEvent, Identity and physical capabilities reported by one selected backend., Asynchronous FIFO source of normalized events from one backend connection. (+19 more)

### Community 31 - "test_enhanced.py"
Cohesion: 0.11
Nodes (29): AsyncEnhancedUartSender, EnhancedNdjsonEventStream, Translate complete UART payloads through an async Enhanced transport., Parse Enhanced NDJSON chunks and expose only normalized evidence events., Return an incomplete Enhanced NDJSON frame buffered by the parser., FrameTooLargeError, HostCommandFrameTooLargeError, Raised before decoding when a device-to-host frame exceeds its bound. (+21 more)
...
Cohesion: 0.06
Nodes (35): Configure a control channel GPIO mode., GpioModeRequestSource, GPIO mode configuration workflow., Send `configure_gpio_mode` and record the firmware result., _format_utc_timestamp(), GpioConfigurationError, GpioControlChannelState, GpioModeRejection (+27 more)
...
### Community 39 - "SegmentContext"
Cohesion: 0.06
Nodes (22): _AsyncEnhancedAdapter, EnhancedAsyncHost, _open_host_on_owner_loop(), OpenAsyncEnhancedAdapter, _OpenedHost, Any, BackendEvent, ControlState (+14 more)
...
Cohesion: 0.08
Nodes (41): Register service exception handlers on an app., register_error_handlers(), BaselineOperation, clear_baseline(), _ineligibility_reason(), mark_baseline(), _persistence_fault(), datetime (+33 more)
...
Cohesion: 0.07
Nodes (37): backend_input_error_from_protocol(), enhanced_message_timestamp_us(), enhanced_segment_context(), normalize_enhanced_hello(), normalize_enhanced_message(), BackendEvent, DeviceMessage, Enhanced v1 protocol adapters and normalized event translation. (+29 more)
...
Cohesion: 0.10
Nodes (17): BlockingCaptureSource, ClosableFakeRuntime, _hardware_config(), NoopDeviceControl, BackendEvent, ControlState, Exception, MonkeyPatch (+9 more)
...
Cohesion: 0.06
Nodes (33): Reference to a created debug session., SessionHandle, CommandedBootMode, SessionDetail, SessionWorkflow, Create filesystem-backed debug sessions., Persist derived records finalized at segment or session close., Append one accepted normalized control action atomically. (+25 more)

### Community 58 - "test_report_boundary.py"
Cohesion: 0.19
Nodes (30): AnalysisUnavailable, prepare_analysis(), ProviderSelection, Exception, Analysis-only failure; never a capture or storage failure., Freeze the exact request and expose a manifest before any provider call., asyncio, Path (+22 more)
...
Cohesion: 0.06
Nodes (55): test_capture_summary_serializes_bounded_first_error_evidence(), _validate_session_command(), EvidenceTypeCount, FirstError, FirstErrorReference, LegacySessionListItem, NativeSessionListItem, Reference-bearing view of the first stored failure-pattern match. (+47 more)
...
### Community 66 - "BackendCapabilityPolicy"
Cohesion: 0.10
Nodes (14): BasicSerialPort, Protocol, Small raw pyserial surface owned by the Basic backend., Read up to ``size`` raw UART bytes., Write raw UART bytes., Close the serial port., Return the owned raw serial port for the receive adapter., Return the configured software capability policy. (+6 more)
...
Cohesion: 0.18
Nodes (16): GpioConfigurator, Configure GPIO modes through firmware and update accepted host state., InputValidationError, Raised when an application input violates a Device Core contract., FakeDeviceControl, ControlState, test_configure_mode_accepts_boot_role_with_idle_level(), test_configure_mode_records_firmware_rejection() (+8 more)
...
Cohesion: 0.05
Nodes (76): CaptureRecorder, CaptureRecordResult, CaptureWorkflow, BackendEvent, CommandedBootMode, Exception, SessionWorkflow, Create one capture session. (+68 more)
...
### Community 80 - "test_enhanced_async.py"
Cohesion: 0.17
...
### Community 87 - "provider_boundary.py"
Cohesion: 0.10
Nodes (26): _context(), main(), _parser(), ArgumentParser, Path, Host-facing preview and digest-approved Debug Agent analysis., EvidenceLimits, OllamaAdapter (+18 more)
...
### Community 98 - "UartIntegrity"
Cohesion: 0.12
Nodes (12): backend_snapshot(), setter, Catches replacement publishing connected health without its validated identity., Catches a failed replacement segment lookup partially publishing the candidate., Catches rejected idle replacement candidates being left open., segment(), test_failed_idle_replacement_publication_closes_candidate(), test_idle_replacement_commits_snapshot_and_next_connection_generation() (+4 more)
...
### Community 100 - "ScriptedBasicSerial"
Cohesion: 0.13
Nodes (9): _basic_segment(), ConditionBackedBasicSource, _publish_after_barrier(), BackendEvent, BaseException, Exception, ScriptedBasicSerial, test_real_coordinator_discards_idle_basic_event_before_capture() (+1 more)
...
Cohesion: 0.13
Nodes (27): _build_async_enhanced_capture_reconnect(), build_enhanced_capture_reconnect(), ControlState, Keep runtime control ports stable while Enhanced transports are replaced., Publish a newly connected backend control adapter., Keep the runtime UART-send port stable across backend replacement., Publish a newly connected UART-send adapter., Build coordinated Enhanced reopen through the async host boundary. (+19 more)
...
Cohesion: 0.25
Nodes (18): BuildContext, ChangedFile, Reject malformed or unsafe caller context without reading any source path., validate_coding_context(), _package(), parametrize, test_diff_requires_matching_unified_hunk_provenance(), test_optional_build_must_be_an_object_when_supplied() (+10 more)
...
### Community 141 - "FakeDeviceControl"
Cohesion: 0.21
...
Cohesion: 0.25
Nodes (25): build_analysis_request(), Combine native evidence with optional validated caller context., build_session_evidence(), Assemble bounded, priority-selected evidence without changing stored facts., _append_lines(), _native_session(), MonkeyPatch, Path (+17 more)
...
### Community 148 - "test_retrieval.py"
Cohesion: 0.22
...
### Community 150 - "AsyncEnhancedDeviceControl"
Cohesion: 0.15
Nodes (11): DeviceControlError, Raised when a backend rejects or cannot complete a semantic control operation., AsyncEnhancedDeviceControl, _control_success_timestamp(), ControlState, Translate semantic control operations through an async Enhanced transport., AsyncCommandTransport, DeviceMessage (+3 more)
...
### Community 153 - "BufferOverflowMessage"
Cohesion: 0.21
Nodes (13): BufferOverflowMessage, BufferStatusMessage, UART/event ring buffer overflow reported by the Debug Helper., Firmware-side UART ring buffer telemetry., parse_example(), test_parse_buffer_overflow_example(), test_parse_buffer_status_example(), test_parse_error_response_example() (+5 more)

### Community 154 - "backends/__init__.py"
Cohesion: 0.09
Nodes (32): Basic generic USB-to-UART connection, receive, and send adapter., Write a complete UART payload, retrying ordered short writes., apply_capability_policy(), BackendCapabilityError, BackendUartSendResult, BackendWriteError, integrity_for_backend(), BackendCapability (+24 more)

### Community 155 - "DeviceControl"
Cohesion: 0.12
Nodes (11): DeviceControl, ControlState, Protocol, Backend-neutral semantic DUT and GPIO control operations., Configure one physical control channel and return device time., Pulse one configured physical channel and return device time., Apply one configured channel's active or idle state and return device time., Return timestamp provenance once the source origin is established. (+3 more)
...
Cohesion: 0.10
Nodes (15): Apply startup hardware control mappings., Return the current Device Core status., apply_startup_hardware_config(), GpioRoleName, Protocol, Runtime surface needed to apply startup hardware configuration., Return current runtime status., Apply configured hardware control mappings. (+7 more)
...
### Community 187 - "BackendInputError"
Cohesion: 0.10
Nodes (13): _require_matching_enhanced_identity(), _require_matching_enhanced_snapshot(), BackendInputKind, _ReaderFailure, BackendInputError, BackendMode, Raised when a backend emits malformed or otherwise invalid input., Return the same classified failure with workflow-owned context. (+5 more)
...
Cohesion: 0.06
Nodes (24): backend_snapshot(), _CandidateCleanupFailure, _close_unpublished_candidate(), OpenCaptureReplacement, OpenEnhancedHost, BaseException, Event, Exception (+16 more)
...
### Community 200 - "EvidenceQuotaExceeded"
Cohesion: 0.18
...
Cohesion: 0.61
Nodes (7): Path, _snapshot(), _store(), test_loads_bounded_native_facts_without_raw_artifacts(), test_rejects_legacy_session_without_inferred_native_facts(), test_rejects_path_traversal_session_id(), test_rejects_unknown_session_schema()
...
### Community 210 - "load_backend_config"
Cohesion: 0.29
...
### Community 212 - "UartSendSessionStorage"
Cohesion: 0.29
...
### Community 214 - ".capture_source_health"
Cohesion: 0.20
Nodes (3): Return one immutable health snapshot for the installed source., Return to idle draining and discard unread workflow events., Retain active events because workflow activation owns cursor freshness.

### Community 215 - "test_main.py"
Cohesion: 0.33
...
### Community 231 - "BackendSnapshot"
Cohesion: 0.40
Nodes (3): Accept ownership of one validated concrete replacement., BackendSnapshot, Backend identity, effective policy, timing, and integrity for one segment.

### Community 232 - "BaselineMutationResult"
Cohesion: 0.07
Nodes (17): DeviceCoreSessionStorage, Protocol, SessionDetail, Return one bounded newest-first session page., Return bounded schema-aware detail for one session., Return bounded recent UART replay for one selected native session., Return one authoritative stored detected-pattern record., Designate one eligible session as the project baseline. (+9 more)
...
- **What is the exact relationship between `Phase 1B Enhanced Backend` and `Normalized Backend Contract`?**
  _Edge tagged AMBIGUOUS (relation: implements) - confidence is low._
- **Why does `SessionStore` connect `SessionStore` to `workflows/capture.py`, `FakeMonotonicClock`, `test_log_replay.py`, `FakeDeviceControl`, `test_evidence_package.py`, `DeviceCoreRuntime`, `test_recovery.py`, `test_retrieval.py`, `test_transactions.py`, `models.py`, `SessionPersistenceError`, `test_basic.py`, `fixed_clock`, `SegmentContext`, `CaptureSourceHealth`, `store.py`, `helpers.py`, `test_app_lifecycle.py`, `load_baseline_context`, `test_device_core_uart_send.py`, `retrieval.py`, `test_startup_config.py`, `persistence.py`, `test_capture_reconnect.py`, `EvidenceQuotaExceeded`, `test_session_facts.py`, `test_device_core_wait.py`, `test_baseline.py`, `test_retention.py`, `CaptureRecorder`, `test_reconnect_evidence.py`, `SessionListPage`, `evidence_package.py`, `provider_boundary.py`, `test_connection_monitoring.py`, `test_comparison.py`, `ScriptedBasicSerial`, `BackendSnapshot`, `BaselineMutationResult`, `test_device_core_lifecycle.py`, `UartReceiveEvent`?**
  _High betweenness centrality (0.041) - this node is a cross-community bridge._
- **Why does `SegmentContext` connect `SegmentContext` to `ReconnectedCaptureSource`, `workflows/capture.py`, `FakeMonotonicClock`, `metadata.py`, `test_evidence_package.py`, `CaptureSessionStorage`, `CaptureEventSource`, `DeviceCoreRuntime`, `models.py`, `backends/__init__.py`, `runtime.py`, `DeviceControl`, `BackendInfo`, `DeviceCoreStatus`, `fixed_clock`, `CaptureSourceHealth`, `store.py`, `enhanced.py`, `helpers.py`, `SessionStore`, `BackendInputError`, `backend_reconnect.py`, `test_startup_config.py`, `retrieval.py`, `BackendCapabilityPolicy`, `test_capture_reconnect.py`, `test_session_facts.py`, `test_device_core_wait.py`, `CaptureRecorder`, `test_reconnect_evidence.py`, `test_enhanced_async.py`, `.__init__`, `test_connection_monitoring.py`, `test_comparison.py`, `UartIntegrity`, `ScriptedBasicSerial`, `test_backend_reconnect.py`, `BasicBackendEventSource`, `test_device_core_lifecycle.py`?**
  _High betweenness centrality (0.037) - this node is a cross-community bridge._
- **Why does `DeviceCoreRuntime` connect `DeviceCoreRuntime` to `ReconnectedCaptureSource`, `workflows/capture.py`, `FakeMonotonicClock`, `FakeDeviceControl`, `CaptureSessionStorage`, `validation.py`, `CaptureEventSource`, `models.py`, `backends/__init__.py`, `DeviceControl`, `runtime.py`, `BackendInfo`, `GpioControlChannelState`, `SegmentContext`, `CaptureSourceHealth`, `store.py`, `GpioModeRegistry`, `test_app_lifecycle.py`, `test_device_core_uart_send.py`, `SessionStore`, `BackendInputError`, `retrieval.py`, `test_startup_config.py`, `BackendCapabilityPolicy`, `CommandSuccessMessage`, `InputValidationError`, `test_device_core_wait.py`, `CaptureRecorder`, `SessionListPage`, `test_connection_monitoring.py`, `UartIntegrity`, `WaitPatternResult`, `BackendSnapshot`, `BaselineMutationResult`, `test_device_core_lifecycle.py`, `UartReceiveEvent`?**
